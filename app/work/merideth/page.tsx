...
export const metadata: Metadata = {
  title: "Merideth — Aphoric Case Study",
  description:
    "Merideth brand identity: warm retro typography, autumnal palette, and mid-century furniture silhouettes.",
};

export default function MeridethPage() {
  const project = {
    slug: "merideth",
    title: "Merideth",
    tag: "brand identity",
