...
export const metadata: Metadata = {
  title: "Terra & June — Aphoric Case Study",
  description:
    "Terra & June brand identity: youthful apparel & eyewear label with Gen Z appeal, bold starburst icons, and vibrant packaging.",
};

export default function TerraJunePage() {
  const project = {
    slug: "tj",
    title: "Terra & June",
    tag: "brand identity",
